...
<div class="shell">
  ...
  <footer class="shell-footer">
    <p class="footer-tagline">Searchable PostgreSQL mailing list history</p>
    <a class="footer-contact" href="mailto:hello@pginbox.dev">hello@pginbox.dev</a>
    <a class="footer-github" href="https://github.com/jbonatakis/pginbox" target="_blank" rel="noopener noreferrer" aria-label="GitHub repository">
...
<style>
  ...
  .shell-footer {
    ...
    gap: 1rem;
    padding-top: 1.25rem;
    border-top: 1px solid rgba(126, 151, 177, 0.25);
  }
